...
const headingStyles = "text-green-400 text-2xl sm:text-3xl font-bold mt-6";
const paragraphStyles = "mt-4 text-sm sm:text-base leading-relaxed";
const listItemStyles = "mt-2 text-sm sm:text-base leading-relaxed";
const linkStyles = "text-green-400 hover:text-pink-600 underline";

const TruthTerms: React.FC = () => {
  return (
    <div className={containerStyles}>
      <PageHeader
        title="Terms of Service"
        description="Welcome to the terms and conditions page! Please read these terms and conditions if you have any questions about Truth."
      />
      <h1 className={headingStyles}>Terms and Conditions</h1>
      <p className={paragraphStyles}>Last updated: March 01, 2024</p>
      <p className={paragraphStyles}>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>

      <h2 className={headingStyles}>Interpretation and Definitions</h2>
      <h3 className="text-xl sm:text-2xl font-semibold mt-4">Interpretation</h3>
      <p className={paragraphStyles}>
      ...
      <h3 className="text-xl sm:text-2xl font-semibold mt-4">Definitions</h3>
      <p className={paragraphStyles}>
      ...
      <ul className="list-disc pl-5">
        <li className={listItemStyles}>
          ...
          the Company downloaded by You on any electronic device, named Truth.
        </li>
        <li className={listItemStyles}>
        ...
        <li className={listItemStyles}>
          ...
          "Us" or "Our" in this Agreement) refers to Truth.
        </li>
        <li className={listItemStyles}>
      ...
      <h2 className={headingStyles}>Acknowledgment</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Links to Other Websites</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Termination</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Disputes Resolution</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>For European Union (EU) Users</h2>
      <p className={paragraphStyles}>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className={headingStyles}>United States Legal Compliance</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Severability and Waiver</h2>
      <h3 className={headingStyles}>Severability</h3>
      <p className={paragraphStyles}>
      ...
      <h3 className={headingStyles}>Waiver</h3>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Translation Interpretation</h2>
      <p className={paragraphStyles}>
      ...
      <h2 className={headingStyles}>Changes to These Terms and Conditions</h2>
      <p className={paragraphStyles}>
      ...
      <ul className="list-disc pl-5">
        <li className={listItemStyles}>By email: gaugerderek@gmail.com</li>
      </ul>
      <Footer
        title={"Thank you for checking out the terms of service for Truth!"}
        content={
